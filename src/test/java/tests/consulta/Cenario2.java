...
public class Cenario2 {
	...
	public void consultaEmpresa() {
		...
		// Escolhe a Empresa
		WebElement localizaEmpresa = driver.findElement(By.cssSelector("#ctl00_Content_grdEmp_ctl40_btnIdEmp"));
		localizaEmpresa.click();
		// #ctl00_Content_grdEmp_ctl40_btnIdEmp
		// #ctl00_Content_grdEmp > tbody > tr:nth-child(40) > td:nth-child(2)

		// Realiza alteração no cadastro
		WebElement alteraEmpresa = driver.findElement(By.cssSelector("#ctl00_Content_txtTelefone"));
		alteraEmpresa.sendKeys("15991611043");

		// Clica no botão Confirmar para finalizar o Cadastro
		WebElement buttonConfirmar = driver.findElement(By.cssSelector("input[id='ctl00_Content_btnConfirmar'"));
